          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2">
                <Image
                  src={stateUserData.avatar || "/images/user/user-06.png"}
                  width={100}
                  height={100}
            ...
            <div className="mt-4">
              <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
                {stateUserData.firstName} {stateUserData.lastName}
              </h3>
              <p className="font-medium">
                {stateUserData.email || ""} | {stateUserData.nationality || ""}{" "}
                | {stateUserData.age || ""}
              </p>
              <div className="g'rid mx-auto mb-5.5 mt-4.5 hidden max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  Hello, my name is {stateUserData.firstName}{" "}
                  {stateUserData.lastName} and I work at Ajwaa Company. I manage
                  the project through this powerful dashboard, and I am very
                  happy to be working at Ajwaa.
                </p>
              </div>
